...
- `__init__.py` — re-exports all protocols: `AgentLogger`, `IAgent`, `ILLMProvider`, `IReasoningStrategy`, `ITool`.
...
- `logger.py` — `AgentLogger`, the structured logging interface used throughout `core/`.
